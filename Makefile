...
${MAIN_NAME}_csim:	${MAIN_NAME}.ino ${HOME}/Arduino/libraries/esp32jimlib/src/jimlib.h ${HOME}/Arduino/libraries/esp32jimlib/src/ESP32sim_ubuntu.h
	g++  -DGIT_VERSION=\"$(GIT_VERSION)\" -x c++ -g $< -o $@ -DESP32 -DUBUNTU -I./ -I${HOME}/Arduino/libraries/esp32jimlib/src 
